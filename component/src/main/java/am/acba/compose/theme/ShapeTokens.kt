...
object ShapeTokens {
    ...
    val shapeRoundEnd: RoundedCornerShape = RoundedCornerShape(topEnd = 100.0.dp, bottomEnd = 100.0.dp)
    val shapeRoundStart: RoundedCornerShape = RoundedCornerShape(topStart = 100.0.dp, bottomStart = 100.dp)
    ...
    val inputShapeLeftSide: RoundedCornerShape = RoundedCornerShape(topStart = 12.0.dp, bottomStart = 12.0.dp)
    val inputShapeRightSide: RoundedCornerShape = RoundedCornerShape(topEnd = 12.0.dp, bottomEnd = 12.0.dp)
    ...
    val shapeCalendar: RoundedCornerShape = RoundedCornerShape(16.dp)
}
