...
class PrimarySlider @JvmOverloads constructor(
    ...
    init {
        context.obtainStyledAttributes(attrs, R.styleable.PrimarySlider).apply {
            ...
            val value = getFloat(R.styleable.PrimarySlider_android_value, 0f)
            val valueTo = getFloat(R.styleable.PrimarySlider_android_valueTo, 0f)
            val valueFrom = getFloat(R.styleable.PrimarySlider_android_valueFrom, 0f)
            val stepSize = getFloat(R.styleable.PrimarySlider_android_stepSize, 0f)
