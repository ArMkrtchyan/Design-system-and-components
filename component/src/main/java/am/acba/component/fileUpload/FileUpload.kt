...
class FileUpload : FrameLayout {
    ...
    private fun getCompressedUri(
        ...
        return if (fileType == FileType.IMAGE) uri.getFileComponent(context, IMAGE_MAX_SIZE)?.toUri() ?: uri else uri
    }
    ...
    companion object {
        private const val IMAGE_MAX_SIZE = 1.2 * 1000 * 1024
        private const val FILE_MAX_SIZE = 1.2 * 1000 * 1000
    }
