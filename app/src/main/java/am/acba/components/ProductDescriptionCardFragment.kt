...
class ProductDescriptionCardFragment : BaseViewBindingFragment<FragmentProductDescriptionCardBinding>() {
    ...
    private fun setProductCard0() {
        ...
        mBinding.productCardFull.setImage(ContextCompat.getDrawable(requireContext(), am.acba.component.R.drawable.investment_cropped))
    ...
    private fun setProductCard1() {
        ...
        mBinding.productCard1.setImage(ContextCompat.getDrawable(requireContext(), am.acba.component.R.drawable.investment_cropped))
    ...
    private fun setProductCard2() {
        ...
        mBinding.productCard2.setImage(ContextCompat.getDrawable(requireContext(), am.acba.component.R.drawable.investment_cropped))
    ...
    private fun setProductCard3() {
        ...
        mBinding.productCard3.setImage(ContextCompat.getDrawable(requireContext(), am.acba.component.R.drawable.investment_cropped))
    ...
    private fun setProductCard4() {
        ...
        mBinding.productCard4.setImage(ContextCompat.getDrawable(requireContext(), am.acba.component.R.drawable.investment_cropped))
    ...
    private fun setProductCard5() {
        ...
        mBinding.productCard5.setImage(ContextCompat.getDrawable(requireContext(), am.acba.component.R.drawable.investment_cropped))
    ...
    private fun setProductCard6() {
        ...
        mBinding.productCard6.setImage(ContextCompat.getDrawable(requireContext(), am.acba.component.R.drawable.investment_cropped))
