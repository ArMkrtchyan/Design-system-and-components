...
enum class ComponentTypeEnum(val componentName: String, val isCompose: Boolean, val navigationId: Int, val isReady: Boolean = false) {
    ...
    CARD_LISTING_COMPOSE("Card listing", true, R.id.cardListingComposeFragment),
    ...
    EMPTY_SCREEN_COMPOSE("Empty screen", true, R.id.emptyStateComposeFragment),
    EXCHANGE("Exchange", false, R.id.exchangeFragment),
    EXCHANGE_COMPOSE("Exchange", true, R.id.exchangeComposeFragment),
    ...
    PRODUCT_CARD_VIEW_COMPOSE("Product Card view component", true, R.id.cardViewComposeFragment),
    ...
    TIME_LINE("Primary TimeLine", true, R.id.timeLineFragment),
    TIME_LINE_COMPOSE("Primary TimeLine", true, R.id.timeLineComposeFragment),
