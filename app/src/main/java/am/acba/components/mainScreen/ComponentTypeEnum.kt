...
enum class ComponentTypeEnum(val componentName: String, val isCompose: Boolean, val navigationId: Int, val isReady: Boolean = false) {
    ...
    CARDS_ITEM_COMPOSE("Cards Item", true, R.id.cardsItemsFragment,isReady = true),
    ...
    DATA_TABLE("Data table", true, R.id.dataTableComposeFragment),
    DATE_PICKER_COMPOSE("Date picker and Calendar", true, R.id.datePickerComposeFragment, isReady = true),
    ...
    DROP_DOWN("Drop downs", false, R.id.dropDownFragment, true),
    DROP_DOWN_COMPOSE("Drop downs", true, R.id.dropDownComposeFragment, true),
    ...
    FILE_UPLOAD_COMPOSE("File upload", true, R.id.fileUploadComposeFragment),
    GUIDE_COMPOSE("Guide", true, R.id.guideComposeFragment, isReady = true),
    ...
    PHONE_NUMBER_INPUT_COMPOSE("Phone number input", true, R.id.phoneNumberInputComposeFragment,isReady = true),
    PI_CHART("Pie chart", true, R.id.pieChartComposeFragment),
    PIN_INPUT("Pin input", false, R.id.pinInputFragment),
    PIN_INPUT_COMPOSE("Pin input", true, R.id.pinInputComposeFragment, isReady = true),
    PRIMARY_TAB_LAYOUT("Primary Tab", false, R.id.tabLayoutFragment),
    PRIMARY_TAB_LAYOUT_COMPOSE("Primary Tab", true, R.id.tabLayoutComposeFragment, isReady = true),
    ...
    PROGRESS_CARD_VIEW_COMPOSE("Progress View", true, R.id.progressCardViewComposeFragment, isReady = true),
    ...
    STOCK_LIST_ITEM("Stock list item", true, R.id.stockListItemComposeFragment, isReady = true),
